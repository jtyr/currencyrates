...
/**
 * Class for the Raiffeisen Bank.
 * 
 * @author Jiri Tyr
 * 
 */
public class RaiffeisenBank extends Bank {
    private final String TAG = "CR: ReiffeisenBank";
     ...
     * @param resources
     */
    public RaiffeisenBank(Resources resources) {
                        ...
                        for (int j = 0; j < list.getLength(); j++) {
                            ...
                            if (n.getNodeType() == Node.ELEMENT_NODE && n.getNodeName().equals("exchange_rate")) {
                                ...
                                for (int k = 0; k < n.getAttributes().getLength(); k++) {
                                    ...
                                    if (a.getNodeName().equals("type") && a.getNodeValue().equals("XML_RATE_TYPE_EBNK_" + mExchangeDirection + "_" + mExchangeType)) {
                                        if (DEBUG > 1)
    ...
    public int getCurrencyEntries() {
        return R.array.RB_CZ_select_currency;
    }

    @Override
    public int getCurrencyEntryValues() {
        return R.array.RB_CZ_select_currency_values;
    }

    @Override
    public String getDefaultCurrencyValue() {
        return mResources.getString(R.string.RB_CZ_default_currency);
    }

    @Override
    public Uri getWebUri() {
        return Uri.parse(mResources.getString(R.string.RB_CZ_url_web));
    }
    ...
    public String getDataUrl() {
        ...
        return mResources.getString(R.string.RB_CZ_url_data, cal.get(Calendar.DAY_OF_MONTH), cal.get(Calendar.MONTH), cal.get(Calendar.YEAR));
    }

    @Override
    public String getAlias() {
        return mResources.getString(R.string.RB_CZ_alias);
    }

    @Override
    public String getRateFormat() {
        return mResources.getString(R.string.RB_CZ_rate_format);
    }
}